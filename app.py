...
# Inisialisasi TavilyClient dengan API key Anda
import os
...
if st.button("Generate Report"):
    ...
    Instruksi:
    1. Hanya buat product_description untuk bagian outline STP yang belum terisi atau belum lengkap berdasarkan hasil dari iterasi sebelumnya.
    2. Buat Query dengan bahasa Indonesia dan juga Inggris.
    3. Buat product_description dengan gaya dan kedalaman yang berbeda, mencakup aspek umum dan spesifik sesuai kebutuhan outline.
